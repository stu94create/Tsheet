// Timesheet v3 service worker — caches the app shell for offline use.
// Bump V when you publish a change so clients pick up the new version.
// NOTE: uses the 'ts3-' prefix so it never shares a name with the root/v2
// workers ('ts-v23'). Their activate handlers delete every cache that isn't
